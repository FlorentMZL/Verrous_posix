...
int rl_fcntl(rl_descriptor descriptor, int command, struct flock *lock)
{
    ...
    case F_SETLK:
        ...
        case F_RDLCK:
            ...
            long int region_end = lock->l_len + lock_length;
            BOOLEAN has_next = TRUE;
            while (has_next)
            {
        ...
        case F_WRLCK:
            ...
            region_end = lock->l_len + lock_length;
            has_next = TRUE;
        ...
        case F_UNLCK:
            ...
            else
            {
                ...
                long int right_lock_length = current_lock.starting_offset + lengthCurrent - (lock->l_start + lock_length);
